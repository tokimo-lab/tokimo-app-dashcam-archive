...
pub struct SourceReq {
    ...
    pub preflight_bitrate_ref: Option<i32>,
    pub hybrid_health_check: Option<bool>,
...
impl From<sources::Model> for SourceDto {
    fn from(model: sources::Model) -> Self {
        Self {
            ...
            preflight_bitrate_ref: model.preflight_bitrate_ref,
            hybrid_health_check: model.hybrid_health_check,
...
async fn source_input(db: &DatabaseConnection, req: SourceReq, user_id: Uuid) -> Result<SourceInput, AppError> {
    ...
    Ok(SourceInput {
        ...
        preflight_bitrate_ref: req.preflight_bitrate_ref.unwrap_or(5_000_000),
        hybrid_health_check: req.hybrid_health_check.unwrap_or(true),
...
async fn patch_source_input(
    ...
    Ok(SourceInput {
        ...
        preflight_bitrate_ref: req.preflight_bitrate_ref.unwrap_or(existing.preflight_bitrate_ref),
        hybrid_health_check: req.hybrid_health_check.unwrap_or(existing.hybrid_health_check),
